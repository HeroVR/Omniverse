...
public class HVScrollView : MonoBehaviour
{
	public delegate void OnHoverChange(HVScrollView scrollview, bool bHover);
    ...
    void Start()
    {
        HVUIEventListener.Get(gameObject).onHover = onHover;
        HVUIEventListener.Get(gameObject).onExit = onExit;
